...
public class cg_DriveForward3p2m extends SequentialCommandGroup {
  private final DriveSubsystem m_drive;
  private final VisionSubsystem m_vision;

  public cg_DriveForward3p2m(DriveSubsystem drive, VisionSubsystem vision) {
    m_drive = drive;
    m_vision = vision;
    ...
    addCommands(
        ...
        new drive_followTrajectory(m_drive, new ThreeTwoMetersForward()), 
