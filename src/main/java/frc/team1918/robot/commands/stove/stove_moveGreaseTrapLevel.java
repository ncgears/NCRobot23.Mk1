...
public class stove_moveGreaseTrapLevel extends CommandBase {
   ...
   */
  public stove_moveGreaseTrapLevel(StoveSubsystem subsystem) {
    m_stove = subsystem;
  ...
  public void initialize() {
    ...
    m_stove.moveGreaseTrapTo(GreaseTrapPositions.LEVEL);
  }
