...
public class Aimer {
	 ...
	 */
    public Aimer(String name, TalonConstants moduleConstants, PIDGains moduleGains){
        m_moduleName = name;
        ...
        m_motor.setNeutralMode(NeutralMode.Coast); //Set controller to coast mode
